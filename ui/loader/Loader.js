...
function FunLoader(_a) {
    ...
    return (React.createElement("div", __assign({ style: { lineHeight: "0", isolation: "isolate", top: 0, left: 0 }, className: "".concat(fixed ? 'fixedLoader' : '', " ").concat(backdrop && fixed ? 'backdropLoader' : '') }, rest), variant === 'simple' ?
        React.createElement("span", { className: "rotate ".concat(funcss ? funcss : '', "  text-").concat(color ? color : '') },
            React.createElement(pi_1.PiSpinnerGap, { style: { fontSize: size + "px", display: 'block' } }))
        : variant === 'duotone' ?
            React.createElement("span", { className: "rotate ".concat(funcss ? funcss : '', "  text-").concat(color ? color : '') },
