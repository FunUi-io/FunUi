...
<Container>
<Div  padding="4rem 0" maxWidth="800px" funcss="center">
...
<Div margin="3rem 0">
    <Grid gap>
        <Col sm={12} md={4} lg={4}>
            <img src='https://raw.githubusercontent.com/FunUi-io/images/main/blog/1.jpg' className='fit round-edge' />
        </Col>
    <Col sm={12} md={8} lg={8}>
<Div padding="1rem 0">
...
<Grid gap>
        <Col sm={12} md={4} lg={4}>
            <img src='https://raw.githubusercontent.com/FunUi-io/images/main/blog/2.jpg' className='fit round-edge' />
        </Col>
    <Col sm={12} md={8} lg={8}>
<Div padding="1rem 0">
<RowFlex justify="space-between">
...
<Grid gap>
        <Col sm={12} md={4} lg={4}>
            <img src='https://raw.githubusercontent.com/FunUi-io/images/main/blog/3.jpg' className='fit round-edge' />
        </Col>
    <Col sm={12} md={8} lg={8}>
<Div padding="1rem 0">
<RowFlex justify="space-between">
