...
var Container = function (_a) {
    ...
    return (React.createElement("div", __assign({ id: id, className: "container ".concat(funcss), style: __assign({ margin: margin || "", padding: padding || "" }, customStyle) }, rest), children));
};
